    ...
    class KMeans:
        ...
        def centroids_find_closest(data, centroids):
            ...
            # Go over every example, find its closest centroid, and store the index inside closest_centroids_ids at the appropriate location.
            # Concretely, closest_centroids_ids(i) should contain the index of the centroid closest to example i. Hence, it should be a value in the range 1...num_centroids.
        ...
        def centroids_compute(data, closest_centroids_ids, num_clusters):
            ...
            # Go over every centroid and compute mean of all points that belong to it. Concretely, the row vector centroids(i, :)
